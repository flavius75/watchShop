...
final class Version20240119145114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, brand_id INT NOT NULL, product_brand VARCHAR(255) NOT NULL, product_model VARCHAR(255) NOT NULL, product_description LONGTEXT NOT NULL, product_movment VARCHAR(255) NOT NULL, product_gender VARCHAR(255) NOT NULL, product_extra JSON DEFAULT NULL, product_price NUMERIC(5, 2) NOT NULL, product_stock SMALLINT NOT NULL, INDEX IDX_D34A04AD44F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
